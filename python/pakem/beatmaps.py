...
# ── AXIS_FRAGMENTS (coming_of_age teen recombination) ──────────────────

AXIS_FRAGMENTS_COMING_OF_AGE = {
    "arc": {
        "first_love_linear": "Track a single unbroken line from first noticing to whatever it becomes, in strict order, no jumps back. Open on the ordinary day just before the topic the user gives tilts everything sideways. Let each scene raise the stakes one notch above the last \u2014 a first glance, a first exchange, a first thing risked \u2014 so the reader feels time pushing forward and never sideways. Keep the narrator fully inside each moment as it lands, guessing at what comes next, never knowing. Withhold the outcome until the final beat. Close on the present-tense edge of not-yet-resolved, the narrator still mid-feeling, still inside the age they are living, never looking down from any later vantage.",
        "friendship_to_love": "Braid two people who already know each other well, then let one thread slowly change color. Open with them easy and unromantic inside the topic the user gives \u2014 the comfort of the established. Plant small snags the narrator notices but can't name: a held glance, a jealousy that makes no sense, a touch that lands wrong. Let the reader see the shift a beat before the narrator does, so the ache is in the lag. Refuse a clean confession scene; let the knowledge arrive crooked and half-denied. Close the instant the old friendship can no longer be pretended into place, the narrator still inside that vertigo, no wiser future voice explaining it.",
        "before_after_threshold": "Split the book on one rite-of-passage event drawn from the topic the user gives. Build the first half entirely in the before-self \u2014 smaller, unknowing, wanting the thing. Render the event itself compressed, almost too fast. Then run the second half as an altered person walking the same rooms, reading the same faces differently, the world unchanged but the eyes new. Never let the narrator narrate the change from outside it; keep them stumbling through the after, comparing only against a before they still half-inhabit. Close inside the after, unsettled, the threshold still fresh under their feet \u2014 no grown voice measuring the distance.",
        "one_summer_bracket": "Bracket the whole arc inside one bounded season built from the topic the user gives \u2014 a stretch with a hard, non-negotiable end already visible from the first page. Open on the season beginning and let the narrator know, dimly, that it must close. Make the ticking clock pressurize every choice: things done because there won't be time later. Let intensity rise precisely because the container is finite. Refuse to extend past the boundary \u2014 when the season ends, the book ends, mid-feeling. Close on the last day of the bracket with things unfinished, the narrator still in it, not one page allowed past the deadline into any older self's summary.",
        "diary_nonlinear": "Assemble the arc as out-of-order fragments the reader must reorder themselves \u2014 entries, scenes, or moments from the topic the user gives, arriving shuffled. Give each fragment its own charged present; never let one narrate another from above. Seed the emotional climax early, before the reader has the context to feel its full weight, then double back to the ordinary beat that made it matter. Let meaning accrue by collision, not sequence. Trust the reader to build the timeline. Keep every fragment locked to the moment of its writing \u2014 a teen mid-experience, never a later hand annotating the stack, never a closing entry that explains the rest.",
        "letter_to_the_unreachable": "Aim the entire arc at one person from the topic the user gives whom the narrator cannot reach \u2014 moved, silent, gone from their daily orbit \u2014 and address it all to that second person, 'you.' Let the wanting-to-say drive every scene: things confessed on the page that were never said aloud. Build through what the narrator would tell them if they could, circling the thing that made them unreachable. Keep it inside the fresh, unhealed present of the gap, not a fond backward recollection. Refuse any reply or reunion. Close still speaking into the silence, the narrator still adolescent and still un-answered, no future where the letter was ever sent.",
    },
    "conflict": {
        "social_hierarchy": "Open on the two leads separated by a visible status gap inside the setting the user gives \u2014 one orbits the top of some pecking order, the other watches from its margin. Structure the arc as a series of crossings: each beat should place them in the same room for a reason that shouldn't happen given where they sit, and cost the higher-placed one a little standing to stay there. Keep the gulf itself present in every scene as pressure, not backdrop. Let a public moment force a choice between the crowd's approval and the other person. Close when one of them stops measuring the distance between them and simply stands on the wrong side of the line on purpose, in front of everyone who was keeping score.",
        "family_economic_pressure": "Open with one lead already carrying a weight at home that the topic's world can't see \u2014 a shift picked up, a thing gone without, a smallness practiced until it looks like a personality. Build the arc so the relationship keeps brushing against what can't be afforded: an outing, an object, a plan the other assumes is easy. Structure the tension as concealment giving way \u2014 a chain of near-discoveries where the burdened one edits themselves to hide the gap. Give the other lead a beat of seeing behind the edit and getting it wrong before getting it right. Close not by erasing the pressure but on the moment the load is finally set down between them and named out loud, shared rather than hidden.",
        "self_worth_fear": "Anchor the whole arc inside one lead's private conviction that they are not enough \u2014 too plain, too much, too late, too little \u2014 and route every beat through that lens. Structure it as a running mistranslation: warmth arrives and gets read as pity or mistake, so the lead flinches, deflects, or sabotages the good thing before it can be taken. Let the pattern escalate until the self-protection nearly destroys what it was guarding. Keep the other person patient but not a therapist \u2014 they can offer a mirror, never the verdict. Close on an internal turn, not a rescue: the moment the lead stops auditioning for their own worth and lets themselves be seen without first apologizing for being there.",
        "distance_or_moving": "Open already holding a countdown \u2014 one lead is leaving the world of the topic, a departure fixed enough that everyone can see the date coming. Structure the arc against that clock: let closeness accelerate precisely because it's ending, each beat sweeter and sharper for being borrowed time. Braid in the temptation to pull away early to soften the landing, and the harder choice to stay fully present anyway. Avoid a last-minute cancellation of the move \u2014 the leaving should be real. Let the middle test whether what's built can survive distance or was only ever proximity. Close on the threshold itself: not with a promise kept or broken, but with the two of them deciding, eyes open, what they're willing to carry across the gap.",
        "friendship_triangle": "Open with a friendship already load-bearing in the topic's world, then let romance rise inside or beside it so the two bonds start competing for the same person's loyalty. Structure the arc as a widening fork: every beat that feeds the new feeling quietly starves the old friendship, and the lead keeps trying to pay both debts at once. Give the friend real gravity \u2014 not an obstacle to clear but a person with a claim. Build to a moment where choosing the romance and keeping the friendship become, briefly, incompatible. Close by refusing the clean trade: land on the lead learning to hold both honestly, or on the ache of what shifts permanently when a friendship has to make room for something it didn't ask for.",
        "first_heartbreak_fear": "Open with one lead standing at the edge of their first real love and flinching from it, because caring this much is a door to a loss they've never survived and can't yet imagine surviving. Structure the arc as approach-and-retreat: each beat that deepens the bond raises the stakes of losing it, so the lead keeps reaching for exits, testing whether it's safer to end things themselves than to be ended. Let the fear masquerade as coolness, caution, or picked fights. Build to a moment where the exit is right there and free. Close on the choice to stay unshielded \u2014 accepting that the possibility of the first heartbreak is the price of the first real thing, and paying it on purpose.",
        "academic_or_future_pressure": "Open with one or both leads pinned under a future that adults have already drawn for them \u2014 an exam, a placement, a plan bearing someone else's name on their years ahead. Structure the arc so the relationship keeps colliding with that scripted path: time stolen from it feels like theft, and the other person starts to look like either the reward for finishing or the thing that derails it. Braid in the quiet question of whose life this even is. Let a decisive checkpoint arrive and force priorities into the open. Close not by resolving the whole future but on a smaller, truer choice \u2014 the moment the lead stops living entirely inside the plan handed to them and claims one thing that is actually theirs.",
        "identity_becoming": "Open with one lead mid-transformation \u2014 shedding an old self, trying on a truer one, not yet sure which fits \u2014 and let the relationship become the mirror where that self gets tested. Structure the arc so attraction and self-discovery run on the same wire: each beat with the other person reveals or unsettles who the lead is becoming, sometimes pulling toward the new self, sometimes tempting a retreat into the familiar one. Keep the romance from being the answer to the question of self \u2014 it can illuminate, never replace, the private work. Build to a moment where being fully seen and being still-unfinished collide. Close on the lead choosing to be met as who they're turning into rather than who they were, half-formed and unhidden.",
    },
    "resolution": {
        "rite_of_passage": "Structure the ending as a crossed threshold. Track one concrete before-state of the lead early in the topic the user gives, then engineer a single ordeal near the close that forces them through it \u2014 an act they could not have performed at the opening. Close on the far side of that line: show the lead handling the same situation, object, or person differently, and let the reader infer the change from behavior alone. Do not narrate the transformation or name it. End the arc on the first ordinary moment after crossing, so the new self is already load-bearing rather than announced. Withhold any restatement of the old self.",
        "bittersweet_growth": "Build twin arcs that diverge at the end. Give the lead and one other figure from the topic separate lines of change, braided in parallel through the middle, and let the resolution move them apart rather than together. Close on a shared final beat where both are visibly different from who they met \u2014 one gain and one loss held in the same frame. Structure the parting as mutual and un-blamed: neither fails the other, the growth simply points them to different places. End before either reaches a new life; hold on the threshold of separation, not its aftermath.",
        "open_future": "Resolve the internal conflict but refuse the external one. Bring the lead's private arc to a clear settling \u2014 a decision made, a fear faced \u2014 then leave the outward outcome of the topic deliberately unfinished. Structure the final beat as a doorway held ajar: a choice pending, a path visible but not yet taken, a question the lead now knows how to hold. Close on forward motion without arrival. Give the reader enough shape to feel the direction and enough silence to feel the uncertainty. Do not resolve who they become; resolve only that they are ready to find out.",
        "chosen_self": "Force a fork between the relationship and the lead's own becoming, and have them choose themselves. Structure the middle so that a bond formed in the topic and the lead's emerging path grow quietly incompatible. At the resolution, stage a single clean decision that keeps the self and releases the bond \u2014 not from anger, but from clarity. Close on the lead alone with the thing they chose, and let the cost of the other person's absence register without regret undoing the choice. End on the first step into the chosen path, small and self-authored. Do not soften it with reunion.",
        "quiet_understanding": "Resolve through alignment, not declaration. Let the lead and one other figure from the topic arrive at a shared knowing that neither says aloud. Structure the final beat around a small exchanged action \u2014 a look held, a thing passed, a place returned to \u2014 that carries the whole understanding. Withhold every explicit statement of feeling; the reader learns the alignment only from what the two do near each other. Close on the gesture and stop. Do not let anyone name what has happened between them, and do not resolve it into more than a mutual recognition quietly reached and quietly kept.",
        "graduation_parting": "Let an external clock, not a choice, end it. Establish early a fixed endpoint inside the topic \u2014 a term closing, a season ending, a place emptying \u2014 and run the arc against that countdown. Structure the middle as time spent knowing it will run out, and the resolution as the clock simply arriving. Close on the last shared moment before the dispersal, with the parting imposed rather than decided. Let the lead's growth show in how they meet the ending, not in stopping it. End at the threshold of scatter; do not follow anyone past it into what comes after.",
        "first_letting_go": "Center the arc on the lead learning to release. Give them something early in the topic they hold too tightly \u2014 a person, a role, an old self-image, a certainty \u2014 and structure the middle as the slow discovery that keeping it costs them. Stage the resolution as a single act of loosening: they open the hand rather than have it pried open. Close on the lightness and the ache together, in the first breath after letting go. Show that the release is a skill newly learned, not a loss suffered. End before they take up anything new; hold on the empty, freed hand.",
    },
    "pov": {
        "first_aku": "Lock the whole brief to one teen's first-person 'aku'. Open inside a single unspoken thought and let every beat reach the reader only after it has passed through this narrator's chest first. Report the setting the user gives strictly as this one body registers it: what the eyes catch, what the stomach does, what goes unsaid. Withhold any fact 'aku' could not yet know; let realization arrive on the page at the exact moment it arrives inside. Keep the interior young at every line, never explained from a safe later distance. Close on an interior admission that only this narrator could make, still standing inside the moment, not looking back on it.",
        "first_gue": "Lock the brief to one teen's first person aimed slightly outward, narrated as if a listener were half-present and being performed for. Open mid-reaction to the topic, already in motion, and let the plot arrive through the narrator's real-time reactions and asides rather than neutral report. Structure each beat as a claim made to that implied listener and then quietly complicated by what the narrator does next, so the reader catches the gap between the stance struck and the thing underneath it. Route the setting the user gives through this performed self-presentation rather than direct description. Keep the narration inside the moment and inside the teen, never resolved from a later vantage. Close on a beat the narrator plays as small that the structure has loaded to land large.",
        "diary_address": "Structure the brief as the teen writing to the page itself \u2014 a diary or private record with no reader who could ever answer, the second-person 'kamu' aimed at the notebook or at the self, never at a person who might receive it. Open by turning inward to that private surface and let the topic surface as things admitted only because no one is listening. Order the beats the way private disclosure builds: the easy admission first, the guarded one arriving only once the writing has warmed enough to hold it. Let the setting the user gives enter as evidence the narrator lays down only for their own eyes. Keep the address unbroken and the voice inside the moment of writing, present-tense, never annotated from afterward. Close mid-entry on the sentence the narrator has been circling and finally sets down for no one but themselves.",
        "close_third_teen": "Write in third person but weld the camera behind one teen's shoulder for the entire brief \u2014 free-indirect, so their word-choices and misreadings bleed into the narration without quotation marks. Report the setting the user gives only as this one teen construes it; let their guesses stand uncorrected on the page. Grant zero access to any other head and no fact this teen has not yet reached. Keep the coloring young at every beat, never lifted to a knowing adult vantage or a wider omniscient eye. Let the gap between what they think is happening and what the reader half-suspects do the work. Close on a small external gesture the teen misreads, and stop there.",
        "collective_kami": "Anchor the brief to a first-person plural 'kami' \u2014 a tight teen pack narrating as one, though one unnamed member holds the pen. Open on something the group does or believes together and let the topic arrive as shared rumor, dare, and consensus. Track the beats as the 'we' tightens or frays: the setting the user gives measured against what the group agreed was true. Let the single narrator's private doubt press against the plural voice without ever breaking to solo 'aku'. Keep it inside the pack and inside the moment, never explained by a grown survivor. Close the instant the 'we' splits \u2014 one beat where the narrator no longer speaks for everyone.",
        "letter_second": "Structure the brief as the teen composing something meant to be sent \u2014 a letter, an unsent message, a note left behind \u2014 addressed throughout to a specific 'kamu' who is a character in the topic, not a diary. Open on the reason it must be written now and let each beat function as a thing the narrator needs this reader to finally understand. Feed the setting the user gives in only where it serves the case being made. Let the order follow persuasion, not chronology, doubling back to soften or push. Keep the voice teen and inside the moment of writing, never revised by a later self. Close on the line that decides whether it gets sent.",
    },
}

_VALIDITY_INCOMPAT_COMING_OF_AGE = {
    ("pov", "letter_second", "arc", "diary_nonlinear"): "Second-person letter voice addressed to a 'you' contradicts a private diary's inward, self-addressed nonlinear entries.",
    ("pov", "diary_address", "arc", "letter_to_the_unreachable"): "Diary form (writing to self) collides with an epistolary arc whose whole structure is a letter to another person.",
    ("pov", "letter_second", "pov", "diary_address"): "Not cross-axis, skip",
    ("pov", "collective_kami", "arc", "first_love_linear"): "A 'we' collective narrator cannot carry an intimate single-protagonist first-love throughline without dissolving its own POV.",
    ("pov", "collective_kami", "arc", "diary_nonlinear"): "A private personal diary is inherently singular and cannot be authored by a collective 'we' voice.",
    ("pov", "collective_kami", "arc", "letter_to_the_unreachable"): "An intimate love-letter to one unreachable person cannot be narrated by a plural 'we'.",
    ("pov", "collective_kami", "resolution", "chosen_self"): "'Choosing who I become' is an individuating resolution that dissolves the collective 'we' the POV depends on.",
    ("pov", "diary_address", "arc", "letter_second"): "axis mismatch, skip",
    ("pov", "letter_second", "conflict", "distance_or_moving"): "none",
    ("arc", "one_summer_bracket", "resolution", "graduation_parting"): "A single-summer bracket excludes the school-year graduation ceremony that a graduation-parting ending requires.",
    ("arc", "before_after_threshold", "resolution", "open_future"): "A before/after threshold arc promises a decisive crossing point, which contradicts a deliberately unresolved open-future ending.",
    ("arc", "first_love_linear", "conflict", "identity_becoming"): "A clean linear first-love spine centers the romance, sidelining the interior identity-formation that must drive an identity-becoming conflict.",
    ("resolution", "graduation_parting", "conflict", "family_economic_pressure"): "A graduation-parting climax frames the stakes around school/leaving, not the household money strain a family-economic conflict foregrounds.",
    ("resolution", "first_letting_go", "arc", "friendship_to_love"): "Friendship-to-love arcs resolve by two people uniting, contradicting a 'first letting go' ending built on release/loss.",
    ("resolution", "rite_of_passage", "conflict", "first_heartbreak_fear"): "A communal/ceremonial rite-of-passage payoff answers a becoming-conflict, not the private romantic dread of first-heartbreak-fear.",
    ("resolution", "quiet_understanding", "arc", "before_after_threshold"): "A loud irreversible threshold crossing undercuts the muted, undramatic register a quiet-understanding ending needs.",
    ("arc", "letter_to_the_unreachable", "resolution", "rite_of_passage"): "An epistolary reach toward someone unreachable ends in acceptance/longing, not the achieved communal milestone of a rite of passage.",
    ("arc", "diary_nonlinear", "resolution", "graduation_parting"): "A fragmented nonlinear diary resists the single fixed ceremonial endpoint a graduation-parting resolution demands.",
    ("pov", "letter_second", "conflict", "friendship_triangle"): "A love-letter locked on one addressed 'you' cannot dramatize a three-way friendship triangle needing multiple present players.",
}

# ── AXIS_FRAGMENTS (kdrama 7-axis recombination) ───────────────────────

AXIS_FRAGMENTS_KDRAMA = {
    "arc": {
        "linear": "Run both threads strictly forward from a single origin point. Open on the first collision between the two leads and the first tremor in the second thread the topic supplies, then advance chapter by chapter in unbroken chronological order. Let the A-thread (the relationship) and the B-thread alternate the wheel: a beat that pulls the leads closer must be immediately taxed by a beat that raises pressure on the second thread, and vice versa, so neither thread rests. Never flash back and never withhold \u2014 the audience knows exactly what the characters know, when they know it. Tighten both threads in lockstep, braiding harder each chapter. Close only when the second thread reaches its final position and the relationship lands its earned one \u2014 the two knots pulled tight in the same scene.",
        "dual_timeline": "Braid two clearly-marked time layers from chapter one: a PAST that ends in ruin and a PRESENT that begins with a return. Open in the present on the leads' cold, changed reunion, then cut to the past for the warm original bond \u2014 and alternate these layers on a fixed rhythm. Carry the A-plot as the wound: what broke the leads THEN and what they are to each other NOW. Carry the B-plot as the buried cause: the engine failure in the past is the mystery the present is forced to re-open. Let each past scene detonate a delayed charge under the present scene beside it. Withhold the exact rupture until late; make its reveal simultaneously answer the relationship and the engine. Close when past and present converge on one moment and both threads resolve together.",
        "non_linear": "Open AFTER a turning point \u2014 begin in the aftermath, the two leads already changed and the second thread already advanced past its first crisis. Deal the chapters as fragments out of order: hard cuts between moments before, during, and long after the turn, trusting the audience to reassemble the sequence. Seed both threads into every fragment \u2014 a shard of the relationship and a shard of the second thread in each \u2014 so meaning accretes by juxtaposition rather than by forward motion. Repeat key images from shifting angles, each pass exposing more of what a scene meant. Let the story's true order surface through reassembly. Close by snapping the last fragment into place so both threads land their final position in one retrospective settling \u2014 whether or not anything was concealed.",
        "ensemble_braided": "Braid three to five threads across one family or institution the topic supplies. Anchor the primary A-plot on the central pairing, but give each satellite figure their own relationship strand and let those strands cross, feed, and sabotage one another. Run the B-plot as the shared engine that binds the whole house \u2014 the external pressure every thread is answering. Rotate POV each chapter or each scene so the ensemble carries the story, no single lead owning it. Let a beat in one thread ripple through the others: a private choice by one member reshapes the collective stakes. Keep all strands live and converging on the same engine crisis. Close when the threads collect in one gathering where the engine resolves and each relationship lands its final position at once.",
    },
    "a_conflict": {
        "family_class": "Open on the topic the user gives, then split the leads across a class line the elders police as law: one holds inherited standing, the other holds none, inside the setting the user gives. Braid so every private tenderness the A-plot earns forces a public cost in the B-plot's institutional world \u2014 a promotion withheld, a table reassigned, a favor called in. Make the elders' enforcement escalate as the pair grows closer, so intimacy and status pull opposite directions. Never let love simply defeat the divide; let each choose what to forfeit. Keep the obstacle external and structural \u2014 the feeling is never in doubt, only whether the world will allow its price.",
        "internal_identity": "Open on a lead who cannot trust the self they've lost or hidden inside the setting the user gives \u2014 a memory gone, a name buried, a mask worn so long it fused. Build the A-plot romance as the one relationship that keeps threatening to expose the hidden self, so closeness becomes danger. Braid with the B-plot so its external pressure keeps prying at the seam: each thread's demand risks surfacing what the lead cannot afford revealed. Let the other person love the mask first and the truth only later. Make the central obstacle interior \u2014 not whether the world permits the love, but whether the lead can be known and survive it. Resolve nothing until the hidden self is chosen aloud.",
        "internal_family": "Open on one family fractured from within, inside the setting the user gives \u2014 two kin estranged by an old wound neither will name first. Keep this thread romance-free; its gravity is blood, not desire. Build the A-plot as the slow, resisted work of return: proximity forced by circumstance, every reconciliation attempt misfiring on buried grievance. Braid with the B-plot so its external stakes keep throwing the estranged kin into the same room against their will, each thread's crisis demanding the cooperation they refuse. Let pride, guilt, and inheritance take turns blocking the door. Make the obstacle the distance between people who share everything and can forgive nothing. Withhold the true rupture's cause until late, then let one kin move first.",
        "forbidden_bloodline": "Open on a love that reads as taboo inside the setting the user gives \u2014 the pair, or the world, believing they may cross a blood line they must not. Build the A-plot so the feeling arrives before the fear, then let the suspected kinship poison every advance with dread and self-disgust. Braid with the B-plot so its external machinery keeps threatening to confirm or expose the bond \u2014 records, resemblances, witnesses surfacing through the other thread's pressure. Let them recoil and return, unable to obey or to stop. Make the obstacle the horror of a wanting that shame forbids. Hold the truth of the bloodline unresolved as long as the tension holds, then reveal whether the line was ever real \u2014 and let that answer cost something either way.",
        "rivals_to_partners": "Open on two equals inside the setting the user gives, both reaching for the same summit \u2014 one prize, one seat, one verdict only one can hold. Build the A-plot as combat first: sabotage, one-upmanship, grudging recognition, the sharp pleasure of a worthy opponent. Braid with the B-plot so its external contest supplies the arena and the stakes, each thread's crisis forcing the rivals to fight side by side against a larger threat. Let the thaw come through competence witnessed, not softness confessed \u2014 respect before warmth, alliance before admission. Make the obstacle the summit itself: to partner is to surrender the win. Withhold whether they can share the peak or must trade it, and let the choice between victory and the other person land last.",
        "gentle_wounds": "Open on two quietly bruised people inside the setting the user gives \u2014 no grand tragedy, only the low ache of ordinary damage carried alone. Build the A-plot as healing without spectacle: small accommodations, noticed silences, the relief of being handled gently by someone who also flinches. Let no villain or divide oppose them; the obstacle is their own guardedness and the fear of needing anyone. Braid with the B-plot so its external demands keep nudging them into shared ordinary hours \u2014 errands, waiting rooms, slow work \u2014 where tenderness accrues by proximity. Keep the pace unforced, the reveals mutual and gradual. Make the drama the courage to be seen mid-repair. Resolve toward steadiness, not rescue \u2014 two people deciding to stop bracing.",
    },
    "b_plot": {
        "chaebol_succession": "Braid a succession war beneath the A-plot relationship: the setting the user gives is an empire, and the question is who inherits it. Seed rival claimants \u2014 an anointed heir, an overlooked one, an outsider married or adopted in \u2014 and tie one lead's fate to that verdict. Run the B-plot so every private intimacy costs public standing: a loyalty shown at home reads as a faction chosen at the table. Escalate personal to structural \u2014 a favored-child slight becomes a boardroom coup, a will becomes a war. Let each act narrow the field until succession and the relationship demand opposite loyalties, then force the choice at the scale the user set. The empire must change hands, or refuse to, because of who these two became.",
        "corporate_takeover": "Braid an outside seizure beneath the A-plot relationship: someone the institution cannot control is coming for it, armed with a dossier, a proxy stake, or a whistleblower's file that could gut the firm the setting the user gives depends on. One lead defends the house; the other holds the thing that topples it \u2014 or discovers they do. Run the B-plot so the takeover tightens as the bond deepens: every disclosure that saves the relationship arms the raider, every act of protection buries evidence. Escalate personal exposure to structural collapse \u2014 a leaked confidence becomes a hostile bid, a private betrayal becomes a public unmaking. Force the endgame at the user's scale: surrender the institution to keep the person, or defend the walls and lose them.",
        "revenge_institution": "Braid a return-to-destroy campaign beneath the A-plot relationship: one figure came back to tear down the family that is also an institution in the setting the user gives, and one lead belongs to what must fall. Run the B-plot as patient demolition \u2014 each act pulls one supporting beam: an ally turned, a secret weaponized, a debt called in \u2014 while the relationship makes the target harder to hate and the avenger harder to abandon. Escalate personal wound to structural ruin \u2014 a childhood injury becomes a dismantled dynasty. Let the campaign's success and the bond's survival move in opposition, so completing the revenge means razing the ground the beloved stands on. Force the reckoning at the user's scale: finish the destruction, or spare the institution and let the wound stay open.",
        "family_birth_secret": "Braid a concealed parentage beneath the A-plot relationship: a lie about who someone's child is, buried a generation ago in the setting the user gives, is surfacing. Plant it early as a wrong date, a resemblance, a sum that doesn't add up, and let one lead carry the truth unknowing. Run the B-plot so each act peels one layer \u2014 a hidden document, a living witness, a matching mark \u2014 and each revelation redraws who owes, who inherits, who may love whom. Escalate the private shame to structural consequence: the secret decides a bloodline, a claim, a legitimacy the setting rests on. Let the disclosure and the relationship pull against each other, the truth threatening the very bond it explains. Force the surfacing at the user's scale \u2014 spoken aloud, or sealed again at a cost that reshapes both threads.",
        "political_corruption": "Braid a rigged institution beneath the A-plot relationship, examined through an ensemble so the stakes read as societal, not personal: the system the setting the user gives runs on is fixed, and ordinary people pay. Distribute the rot \u2014 a bought official, a silenced clerk, a family crushed to keep the machine turning \u2014 and place the leads on opposite sides of exposing it. Run the B-plot so every intimacy implicates the wider web: to shield one person is to shield the fixers, to expose the fixers is to endanger a crowd. Escalate a single injustice to structural indictment \u2014 one rigged case becomes the whole institution on trial. Force the reckoning at the user's scale, where clearing the system and keeping the relationship intact cannot both survive the verdict.",
        "procedural_case": "Braid a buried case beneath the A-plot relationship: a cover-up in the setting the user gives that the two leads work together to unearth, their partnership the engine of the investigation. Open with a small wrong thing \u2014 a closed file, a missing name, a verdict that never fit \u2014 and let each act surface one clue that also exposes one of them. Run the B-plot so proximity is both method and hazard: solving it requires the closeness, and the closeness keeps producing the next lead. Escalate a single overlooked crime to a structural cover-up \u2014 one victim becomes a pattern, one liar becomes an apparatus. Let the truth threaten someone they now cannot lose. Force the case to break at the user's scale: filed and named, or the cover-up wins and the partnership pays for having looked.",
        "craft_or_hearth": "Braid a shared craft as the quiet engine beneath the A-plot relationship: a shop, a kitchen, a workshop, or a household in the setting the user gives that the two tend together, where the real story is made in the ordinary work. Run the B-plot low and steady \u2014 a season's orders, a recipe kept, a repair, a table set \u2014 so the labor itself accretes the bond, each small task a beat of intimacy or friction. Then let the outside world press in: a debt, a rival, a closure, an heir who wants the place sold. Escalate the private hearth to structural stakes \u2014 this small kept thing stands for something larger the community or family relies on. Force the choice at the user's scale: preserve the shared work and what it means, or let it go and lose the ground the relationship grew on.",
    },
    "twist": {
        "chaebol_succession_reveal": "Braid two threads whose stakes look personal on the surface. Plant one recurring formality early \u2014 an agreement, an appointment, a favor that binds the leads to the setting the user gives \u2014 and treat it as background texture the reader stops noticing. At the midpoint, reveal that this arrangement was engineered from the start as a positional move: someone was maneuvering for control of the topic's central seat of power, and the leads were pieces on that board before they were people to each other. Re-thread every earlier warmth so it now reads as leverage being assembled. Close each half by asking whether a bond born inside a power play can outlive the play. Keep the succession's shape drawn only from the topic \u2014 never a named house or title.",
        "hidden_identity_betrayal": "Give one lead a self they present and a self they conceal, and route the whole first half through the presented one. Simultaneously plant a trusted figure \u2014 the confidant, the guide, the one both threads lean on \u2014 as unquestionably safe. At the midpoint, spring two hinges at once: the concealed identity surfaces, and the trusted figure is exposed as knowingly complicit in the harm the leads have been circling. Re-thread every scene of comfort and counsel so the reader sees the double game running underneath it. Let each thread's private trust curdle on the same beat. Close by forcing each lead to choose whom to believe now that the safest voice was the compromised one. Draw the two selves and the betrayal only from the setting the user gives.",
        "birth_secret_incest_fakeout": "Braid two threads pulled toward each other, then plant a lineage fact early \u2014 a shared origin, an overlapping past, a name that recurs across both families in the topic \u2014 dropped as trivia, not alarm. At the midpoint, let that fact detonate as dread: the leads fear their bond crosses a line of blood, and both threads recoil from what was building. Hold the fear as real and load-bearing. Then, before the end, prove the feared connection false \u2014 a substitution, a misrecord, a severed tie native to the topic. Re-thread the earlier closeness as never forbidden, only mislabeled. Close on the cost of the interval spent believing. Keep every genealogical detail sourced from the setting, never invented outside it.",
        "memory_loss_refalling": "Tie the central secret of the topic to a gap in one lead's memory \u2014 an interval they cannot account for, which the other thread quietly holds pieces of. Plant the missing stretch early as small confusions: a familiarity that outpaces acquaintance, a reaction with no remembered cause. At the midpoint, reveal that the two leads share an erased history, and that the forgotten passage is where the secret was born. Let recognition and the secret land together, so re-meeting becomes re-falling. Re-thread every unearned intimacy as the residue of what was lost. Close each half on the question of whether a bond can be chosen twice \u2014 once blind, once knowing. Pull the amnesia's origin entirely from the setting the user gives.",
        "villain_motive_corruption": "Run two threads that each collide with the same antagonist, framed early as ordinary obstruction \u2014 a rival, a gatekeeper, a hard authority inside the topic. Plant the antagonist's small cruelties as personal spite. At the midpoint, reveal the true motive: the antagonist is not the rot's source but its product \u2014 every move traces back to a systemic decay in the topic's central institution, which they serve, exploit, or were broken by. Re-thread each earlier obstruction as a symptom the leads misread as a villain. Let both threads realize the real adversary is the structure, not the face. Close by turning the leads' private conflicts outward, toward the machinery that shaped them. Keep the institution and its rot drawn only from the setting, unnamed beyond it.",
        "distributed_reveals": "Give each thread its own guarded secret and let neither leak into the other for the whole first half \u2014 two separate concealments, two separate silences native to the topic. Plant a faint shared motif across both: a recurring object, phrase, or date that means something different to each holder. At the midpoint, snap both secrets into alignment and reveal they are fragments of ONE older concealment \u2014 a single generational truth the topic's families have carried apart. Re-thread each thread's private logic as a partial view of the same buried event. Let the leads understand each other only once both fragments join. Close on the weight of inheriting a secret neither began. Source every fragment and the generational truth from the setting the user gives.",
        "none": "Braid two threads without a hidden engine beneath them. Plant no secret fuse and spring no plot-level reframe \u2014 let each thread carry its own honest tension drawn from the topic, and let the midpoint be a turn of pressure, not the detonation of a buried fact. Escalate by deepening what is already known: raise the stakes, tighten the collision of the two threads, force earlier choices to compound. No later beat should rewrite the meaning of an earlier one; the reader's first read stays true on a second. Cross the threads at their peak and resolve them on their own terms. Close when both arcs have paid out fully, without a concealed truth waiting to recolor them. (Intensity and dread may still rise \u2014 this forbids a hidden plot mechanism, not tonal heat.) Keep every stake and turn sourced from the setting the user gives.",
    },
    "resolution": {
        "earned_union_after_fallout": "Hold the couple apart until the B-plot exacts its full price. Penultimate: land the B-plot climax so its cost falls squarely on the A-thread pair \u2014 a debt, a severance, a door closed by the topic the user gives. Do not let them reunite before that ledger settles. Final: bring them together only once the paying is visibly done, the union earned by what was surrendered, not by feeling alone. Close on the two of them standing where the loss happened, choosing the join anyway. Let the reunion read as consequence, never as reward the plot handed them.",
        "justice_personal_cost": "Drive the B-thread toward the reckoning the topic demands \u2014 the exposure, the account balanced, the wrong named. Penultimate: land that justice cleanly and let it be right. Final: turn the A-plot on what the justice cost the pair \u2014 the very act that set things straight severs, exiles, or estranges them. Do not undo the justice to spare the bond; hold both true at once. Close on one of them alone with the correct outcome and the emptied place beside them, the win and the wound inseparable in the same frame.",
        "rupture_then_reconcile": "Split the pair open around a truth the B-plot forces into the light. Penultimate: let the B-thread climax detonate the concealment \u2014 the pair break, fully, no soft landing. Final: rebuild the A-plot bond not by burying what surfaced but by holding it in view. Do not restore the earlier version of them; assemble a later one that has metabolized the exposed thing. Close on the two rebuilt past the fracture, the truth now a load-bearing part of what they are, the seam visible and holding.",
        "love_past_memory": "Sever the anchor the bond leaned on \u2014 a memory, a name, a standing the topic can strip away. Penultimate: let the B-plot climax take it, and leave open whether it ever returns. Final: re-form the A-thread bond across that gap, the pull reasserting itself whether or not what was lost comes back. Do not make recovery the condition of the reunion. Close on the two drawn together on the far side of the erasure, the connection proven to sit beneath memory and status, choosing forward from wherever they actually stand.",
        "system_costs_couple": "Let the larger structure of the topic \u2014 institution, obligation, order \u2014 extract something permanent. Penultimate: land the B-plot climax as the system collecting its due, a cost that will not be reversed or bought back. Final: hold the A-plot on the pair choosing each other in full sight of that price. Do not soften the system or let them slip its reach; the loss stands. Close on the two together and diminished, the permanence of what was taken part of the terms they accept, the choosing weightier for being made with open eyes.",
        "family_reconvenes": "Widen the frame past the pair to the family the topic fractured. Penultimate: land the B-plot climax as the thing that forces the scattered household back into one room \u2014 a summons, a return, an account that must be met together. Final: reconvene the A-plot family on honest terms, the old pretense spent, each stated plainly. Do not reset to the prior comfort; gather them into a truer one. Close on the reassembled group holding a shared, unflinching account of itself, the pair inside a whole that has stopped lying to keep the peace.",
        "quiet_healing": "Refuse the crescendo. Penultimate: let the B-plot climax resolve low and inward \u2014 no spectacle, a small correction the topic allows, felt more than shown. Final: settle the A-thread into a quiet, earned steadiness. Do not stage a grand union or a public turn; let the healing arrive as a lowered pulse, a resumed ordinary, a thing that simply holds. Close on the two in a plain moment that would look like nothing from outside, the whole weight of the arc resolved into how unremarkable it has finally been allowed to become.",
    },
    "tone": {
        "makjang": "Pitch both threads at maximum emotional volatility, every chapter running hot with extremity, reversal, and scalding confrontation drawn from the setting the user gives. Open on a surface of order about to crack. Braid the two threads so pressure in one keeps spilling to scald the other, escalating stakes at every crossing rather than letting them settle. Favor the largest feeling the scene will bear \u2014 accusation, sacrifice, betrayal, vow \u2014 and keep raising the temperature until the threads collide in a confrontation that reorganizes every prior alliance. Never let a peak rest; each resolution should expose a steeper one. Close on a reversal charged for still more to come, the braid tightened past comfort. (This sets heat and extremity; whether a buried reveal drives it is left to the twist axis.)",
        "melodrama": "Confine both threads to the intimate scale of a single household or bond inside the setting the user gives, and let no relief of subplot or open air enter. Open mid-obligation, the characters already bound by duty they cannot refuse. Braid the two threads so each pushes the same wound deeper: what one thread sacrifices, the other must witness. Keep the arc airless and inward, every crossing a smaller room than the last, choices narrowing toward one unbearable decision. Let time pressurize rather than pass. Close when the bond is tested past what it can hold, the resolution felt as a cost paid, not an escape earned.",
        "cold_thriller": "Hold both threads under controlled dread \u2014 warmth on the surface, menace running beneath \u2014 in the setting the user gives. Open on ordinary calm that is one degree too still. Braid the two threads so unease travels between them, each crossing tightening the air. Meter the arc by restraint: let dread accrue through small wrongnesses rather than shocks, and keep both threads composed, courteous, deliberate, the calm itself the source of fear. Let the menace surface only at hinge points, then submerge again. Close when the pressure finally breaks the quiet and it does not return \u2014 whether what surfaces is a concealed fact or simply the cost the threads were always driving toward. (This sets a cold, suspenseful register; any buried reveal is supplied by the twist axis, not required here.)",
        "social_drama": "Widen both threads across an ensemble so the setting the user gives is examined through many stations at once, from those who hold power to those it costs. Open on the system, not one face. Braid the two threads so a fracture of class or corruption travels between them, each crossing showing the same rot from a different rung. Keep no single protagonist; let the arc belong to the structure, individuals standing as its instruments and its casualties. Trace consequence upward and downward through the ensemble. Close when the mechanism is laid bare and the ending indicts the arrangement rather than redeeming any one person.",
        "warm_weekend_melo": "Keep both threads gentle and domestic, paced for the long weekend register, in the setting the user gives. Open on ordinary life, a shared table or routine that grounds everyone. Braid the two threads so their troubles interleave without cruelty: a strain in one is met by warmth from the other, hardship softened by the ensemble around it. Widen the arc to hold many small lives, letting minor reconciliations accumulate across chapters rather than one crisis dominating. Let conflict enter, but always within reach of repair. Move unhurried, giving each thread room to breathe. Close on restored belonging, the household wider and more forgiving than it began.",
        "rom_com_to_melo": "Open both threads in light friction, mismatched intentions and comic collision inside the setting the user gives, and braid them as a courtship that keeps almost working. Let the two threads spar, misread each other, and delay. Then, at the midpoint, break the register: reveal a cost or wound beneath the play that the comedy was hiding, and let the arc harden from there. Recast every earlier lightness as prelude to the weight now surfacing. Braid the back half so the two threads must choose each other under real consequence, not banter. Close in the melodramatic key, the warmth earned through what the turn made it survive.",
    },
    "scale": {
        "personal": "Keep the B-plot's blast radius sealed to two people and the handful of kin who share their air. Stake it on one private secret, debt, or wound that only the leads and one or two immediate relatives carry; nobody outside that circle need ever learn what turned. Braid every B-plot beat so its fallout lands on the couple's own bodies and their nearest family \u2014 a parent, a sibling \u2014 never on a company, a court, or a crowd. Let the midpoint reversal detonate inward: it changes who these two are to each other, not who governs anything. Close the B-plot when the last withheld thing is finally spoken between them; the wider setting the user gives goes on undisturbed, unaware anything moved.",
        "family": "Pitch the B-plot's stakes at exactly one household or bloodline \u2014 a lattice of parents, children, in-laws, and the inheritance or buried origin that binds them. Introduce the extended kin as a board of players early, each with a claim; braid the B-plot so every reveal reorders their standings inside that single roof. Keep consequences domestic: a name, a will, a lineage, a seat at the table \u2014 nothing spills to the institution the topic sits in. Fire the midpoint twist as a genealogical shock that re-sorts who owes whom across the whole clan. Route the penultimate B-plot climax through a full-family confrontation, then let the A-plot land as one pairing either restored to the fold or cut loose from it.",
        "corporate": "Set the B-plot inside a single institution the topic supplies \u2014 an organization, house, or body with its own seat of authority \u2014 and make its stakes the control of that entity: who leads it, who is displaced, who inherits it. Stand up rival power-holders as the B-plot's engine, and braid each act so a relationship beat and a maneuver-for-control beat advance together. Keep the reach bounded to the institution's own walls; the wider public stays offstage. Land the midpoint reversal as a shift in who holds the entity. Drive the penultimate chapter to the decisive internal reckoning \u2014 the seat won or seized \u2014 then resolve the A-plot as a private cost paid for that victory. Draw the institution and its offices only from the setting the user gives.",
        "societal": "Aim the B-plot at an institution whose fall implicates a whole system \u2014 a ministry, a court, a hospital, a press, whatever public body the topic offers \u2014 so that exposing one rot indicts the structure around it. Seed victims and witnesses beyond the leads early; braid the B-plot so each relationship beat is shadowed by a beat that widens the wrong from private to systemic. Keep escalating outward: what began as one grievance must be shown to be endemic, many people harmed the same way. Detonate the midpoint twist as proof the corruption is structural, not personal. Climax the penultimate chapter on a public reckoning that unseats the institution, and let the A-plot resolve inside the crater the system's collapse leaves behind.",
    },
}

_VALIDITY_INCOMPAT_KDRAMA = {
    ("twist", "chaebol_succession_reveal", "b_plot", "chaebol_succession"): "This is a false clash to skip \u2014 but noting: reveal presupposes the succession plot, so it is REQUIRED not incompatible; excluded from matrix.",
    ("twist", "chaebol_succession_reveal", "scale", "personal"): "A succession-power reveal needs a corporate/dynastic stage; a purely personal scale has no succession apparatus to reveal.",
    ("twist", "chaebol_succession_reveal", "scale", "societal"): "Succession reveal is an intra-dynasty power bombshell; societal scale diffuses it past the family boardroom where the reveal lands.",
    ("twist", "chaebol_succession_reveal", "tone", "rom_com_to_melo"): "A boardroom succession bombshell as the pivot overrides the light rom-com opening tonal register; the twist forces melo/thriller too early.",
    ("twist", "birth_secret_incest_fakeout", "scale", "corporate"): "Birth-secret/incest-fakeout is a bloodline/family-melodrama device; corporate scale centers institutional power, not lineage panic.",
    ("twist", "birth_secret_incest_fakeout", "scale", "societal"): "The fakeout hinges on intimate family secrets between two lovers; societal scale has no mechanism to stage or resolve it.",
    ("twist", "birth_secret_incest_fakeout", "tone", "cold_thriller"): "Birth-secret/incest-fakeout is quintessential makjang/melo pathos; cold-thriller register cannot deliver the emotional whiplash it needs.",
    ("twist", "birth_secret_incest_fakeout", "tone", "social_drama"): "The fakeout is coincidence-driven melodrama; social-drama tone is grounded and issue-realist, rejecting the contrivance.",
    ("twist", "memory_loss_refalling", "tone", "cold_thriller"): "Memory-loss-and-refalling is a tender melo device about re-earning love; cold-thriller register nullifies its warmth.",
    ("twist", "memory_loss_refalling", "tone", "social_drama"): "Refalling via amnesia is romantic contrivance; social-drama's realist frame rejects the amnesia-melodrama mechanism.",
    ("twist", "memory_loss_refalling", "resolution", "justice_personal_cost"): "Amnesia-refalling drives toward reunion-through-love; a justice-at-personal-cost ending answers a different (moral/legal) question the twist never poses.",
    ("twist", "villain_motive_corruption", "scale", "personal"): "A corruption-motive reveal presupposes institutional wrongdoing to expose; personal scale has no corrupt system in frame.",
    ("twist", "villain_motive_corruption", "tone", "rom_com_to_melo"): "Exposing systemic corruption as the pivot pulls the story into thriller/social territory the rom-com-to-melo arc cannot absorb.",
    ("twist", "villain_motive_corruption", "tone", "warm_weekend_melo"): "Corruption-exposure is a hard institutional beat; warm-weekend-melo's cozy family register can't host the antagonistic reveal.",
    ("twist", "villain_motive_corruption", "resolution", "quiet_healing"): "A corruption bombshell demands reckoning/exposure payoff; a quiet-healing ending leaves the exposed system unaddressed.",
    ("twist", "villain_motive_corruption", "resolution", "love_past_memory"): "Corruption reveal sets up a justice/systemic payoff; a love-transcending-memory ending resolves an emotional thread the twist never raised.",
    ("twist", "distributed_reveals", "arc", "linear"): "Distributed-reveals requires multiple staggered bombshell nodes; a single linear through-line has no structure to distribute them across.",
    ("twist", "distributed_reveals", "tone", "warm_weekend_melo"): "A cadence of successive reveals is high-plot machinery; warm-weekend-melo's slow slice-of-family rhythm can't sustain it.",
    ("twist", "none", "arc", "non_linear"): "Non-linear arc withholds and reorders information to detonate a reframe; twist=none removes the bombshell that justifies the scrambling.",
    ("twist", "none", "arc", "dual_timeline"): "Dual-timeline exists to converge past and present on a revelation; with no twist there is nothing for the timelines to reveal on convergence.",
    ("twist", "none", "resolution", "rupture_then_reconcile"): "Rupture-then-reconcile needs a midpoint bombshell to cause the rupture; twist=none supplies no trigger for the break.",
    ("twist", "none", "resolution", "love_past_memory"): "Love-past-memory presupposes a memory/identity bombshell to transcend; with no twist there is no obstacle for love to overcome.",
    ("twist", "none", "resolution", "justice_personal_cost"): "Justice-at-personal-cost resolves an exposed wrong; twist=none means no concealed wrong ever surfaces to demand justice.",
    ("twist", "none", "tone", "makjang"): "Makjang is defined by escalating shock bombshells; twist=none strips out the very reveals that constitute the register.",
    ("twist", "none", "tone", "cold_thriller"): "Cold-thriller is engineered around concealed information and its detonation; with no twist there is no thriller mechanism left.",
    ("twist", "hidden_identity_betrayal", "tone", "warm_weekend_melo"): "A hidden-identity betrayal is an adversarial gut-punch; warm-weekend-melo's family-comfort register can't accommodate the betrayal turn.",
    ("twist", "hidden_identity_betrayal", "resolution", "quiet_healing"): "Betrayal-by-hidden-identity demands confrontation/fallout payoff; a quiet-healing ending skips the reckoning the twist sets up.",
    ("resolution", "system_costs_couple", "scale", "personal"): "A system-exacts-a-cost-on-the-couple ending requires an institutional/societal antagonist; personal scale has no system to impose the cost.",
    ("resolution", "system_costs_couple", "tone", "rom_com_to_melo"): "A downbeat systemic-sacrifice ending contradicts the buoyant trajectory a rom-com-to-melo promises its couple.",
    ("resolution", "family_reconvenes", "scale", "societal"): "Family-reconvenes is a domestic-reunion payoff; societal scale's stakes resolve at the collective level, not the family table.",
    ("resolution", "justice_personal_cost", "scale", "personal"): "Justice-at-personal-cost implies a public/institutional wrong being answered; personal scale has no external injustice to litigate.",
    ("resolution", "justice_personal_cost", "tone", "warm_weekend_melo"): "A bittersweet justice-with-sacrifice ending clashes with warm-weekend-melo's reassuring, low-stakes emotional contract.",
    ("resolution", "quiet_healing", "tone", "makjang"): "Makjang thrives on unresolved escalation and shock; a restrained quiet-healing ending betrays its maximalist register.",
    ("resolution", "love_past_memory", "twist", "villain_motive_corruption"): "Love-transcending-memory needs a memory/identity twist to transcend; a corruption-motive twist gives it no memory obstacle to resolve.",
    ("tone", "cold_thriller", "resolution", "family_reconvenes"): "Cold-thriller drives toward exposure and cost, not domestic warmth; a family-reconvenes ending tonally reverses the whole register.",
    ("tone", "cold_thriller", "resolution", "quiet_healing"): "A cold-thriller's tension resolves through revelation/reckoning; quiet-healing dissolves the stakes it built without paying them off.",
    ("tone", "social_drama", "scale", "personal"): "Social-drama tone frames private lives against structural forces; a purely personal scale removes the societal lens that defines it.",
    ("tone", "makjang", "scale", "societal"): "Makjang's shocks are intimate-familial (affairs, births, revenge); societal scale disperses the melodrama past the family unit it needs.",
    ("arc", "ensemble_braided", "resolution", "earned_union_after_fallout"): "Earned-union-after-fallout centers one couple's arc; ensemble-braided spreads focus across many threads with no single union to earn.",
    ("arc", "ensemble_braided", "twist", "memory_loss_refalling"): "Amnesia-refalling is a two-hander intimate device; ensemble-braided structure has no single dyad to carry the memory arc.",
    ("a_conflict", "internal_family", "resolution", "earned_union_after_fallout"): "internal_family thread is romance-free \u2014 no couple union to earn",
    ("a_conflict", "internal_family", "resolution", "love_past_memory"): "romance-free A-plot can't resolve on a re-falling",
    ("a_conflict", "gentle_wounds", "tone", "makjang"): "gentle quiet healing clashes with operatic makjang",
    ("a_conflict", "gentle_wounds", "tone", "cold_thriller"): "tender healing vs controlled-dread thriller",
    ("a_conflict", "gentle_wounds", "scale", "societal"): "intimate wounds don't scale to an institution's fall",
    ("a_conflict", "gentle_wounds", "scale", "corporate"): "gentle-wounds is personal, not a corporate war",
    ("a_conflict", "gentle_wounds", "twist", "hidden_identity_betrayal"): "betrayal bombshell breaks the gentle register",
    ("a_conflict", "rivals_to_partners", "twist", "birth_secret_incest_fakeout"): "rivalry arc doesn't want an incest-fakeout",
    ("b_plot", "craft_or_hearth", "scale", "societal"): "a hearth/shop engine can't carry societal scale",
    ("b_plot", "craft_or_hearth", "scale", "corporate"): "craft/hearth is intimate, not a corporate empire",
    ("b_plot", "craft_or_hearth", "tone", "makjang"): "quiet hearth vs makjang is a register clash",
    ("b_plot", "craft_or_hearth", "twist", "villain_motive_corruption"): "hearth engine too small for an institutional-rot reveal",
    ("b_plot", "political_corruption", "scale", "personal"): "corruption is systemic \u2014 not a two-person scale",
    ("b_plot", "political_corruption", "scale", "family"): "political-corruption needs societal, not family scale",
    ("b_plot", "political_corruption", "tone", "warm_weekend_melo"): "corruption indictment vs warm weekend-drama",
    ("b_plot", "procedural_case", "tone", "warm_weekend_melo"): "an investigation vs gentle weekend register",
    ("b_plot", "revenge_institution", "tone", "warm_weekend_melo"): "cold demolition vs warm weekend-melo",
    ("b_plot", "corporate_takeover", "scale", "personal"): "a takeover is structural, not a two-person scale",
}

# ══ coming_of_age + kdrama recombination engines (dedicated axes, 2026-07-06) ══════════
# coming_of_age gets TEEN-locked axes (not the adult-literary romance axes it used to borrow
# via family aliasing); kdrama gets a 7-axis engine (arc/a_conflict/b_plot/twist/resolution/
# tone/scale). Both mirror compose_beatmap_romance. select_beatmap dispatches by STYLE first
# (coming_of_age → teen engine) then by FAMILY, so coming_of_age keeps romance PRESET access.
_COMING_OF_AGE_STYLES = frozenset({"remaja_coming_of_age", "coming_of_age"})
_COA_ORDER = ("arc", "conflict", "resolution", "pov")
_KDRAMA_ORDER = ("arc", "a_conflict", "b_plot", "twist", "resolution", "tone", "scale")


def compose_beatmap_coming_of_age(axes, *, override_id=None, rng=None):
    """Free-compose a TEEN coming-of-age beat-map from dedicated axes. None if invalid."""
    for a in _COA_ORDER:
        if a not in axes or axes[a] not in AXIS_FRAGMENTS_COMING_OF_AGE.get(a, {}):
            return None
    for (a1, v1, a2, v2), _r in _VALIDITY_INCOMPAT_COMING_OF_AGE.items():
        if axes.get(a1) == v1 and axes.get(a2) == v2:
            return None
        if axes.get(a2) == v1 and axes.get(a1) == v2:
            return None
    body = ["STRUKTUR CERITA (compose):"]
    for axis in _COA_ORDER:
        body.append(AXIS_FRAGMENTS_COMING_OF_AGE[axis][axes[axis]])
    trust = ("TRUST THE READER — no real-world statistic citation, no inline term "
             "glossary, no genre self-reference. Be the story, don't narrate it.")
    key = override_id or ("compose_coa_" + "_".join(axes[a] for a in _COA_ORDER))
    return {
        "beatmap_id": key,
        "family": "romance",
        "display_name": f"Compose CoA [{axes['arc']} · {axes['conflict']} · {axes['resolution']} · {axes['pov']}]",
        "tone": "composed",
        "axes": dict(axes),
        "structural_prompt": "\n\n".join(body) + "\n\n" + trust,
        "chapter_spine": _generic_6_spine(axes),
...
def _generic_6_spine_kdrama(axes):
    return [
        "Ch 1-2 — SETUP: open the A-plot relationship + SEED the B-plot engine; braid from the first chapter",
        "Ch 3-4 — ENTANGLE: the two threads fuse; stakes named at the chosen SCALE",
        "Ch ~mid — MIDPOINT TWIST: fire the TWIST; recontextualize every earlier scene",
        "Ch mid+ — FALLOUT: masks drop, the threads converge, the TONE hardens",
        "Ch penultimate — B-PLOT CLIMAX: the engine resolves at real cost",
        "Ch final — A-PLOT LANDING: the relationship lands per the RESOLUTION shape",
    ]


def compose_beatmap_kdrama(axes, *, override_id=None, rng=None):
    """Free-compose a two-thread K-drama beat-map from 7 axes. None if invalid."""
    for a in _KDRAMA_ORDER:
        if a not in axes or axes[a] not in AXIS_FRAGMENTS_KDRAMA.get(a, {}):
            return None
    for (a1, v1, a2, v2), _r in _VALIDITY_INCOMPAT_KDRAMA.items():
        if axes.get(a1) == v1 and axes.get(a2) == v2:
            return None
        if axes.get(a2) == v1 and axes.get(a1) == v2:
            return None
    body = ["STORY STRUCTURE (compose) — braid A-PLOT (relationship) + B-PLOT (engine) in every chapter:"]
    for axis in _KDRAMA_ORDER:
        body.append(AXIS_FRAGMENTS_KDRAMA[axis][axes[axis]])
    trust = ("TRUST THE READER — no real-world statistic citation, no inline term "
             "glossary, no genre self-reference. Be the story, don't narrate it.")
    key = override_id or ("compose_kd_" + "_".join(axes[a] for a in _KDRAMA_ORDER))
    return {
        "beatmap_id": key,
        "family": "kdrama",
        "display_name": "Compose KD [" + " · ".join(axes[a] for a in _KDRAMA_ORDER) + "]",
        "tone": axes.get("tone", "composed"),
        "axes": dict(axes),
        "structural_prompt": "\n\n".join(body) + "\n\n" + trust,
        "chapter_spine": _generic_6_spine_kdrama(axes),
    }


def valid_combo_count_coming_of_age():
    n = 1
    for ax in _COA_ORDER:
        n *= max(1, len(AXIS_FRAGMENTS_COMING_OF_AGE.get(ax, {})))
    return int(n * 0.7)


def valid_combo_count_kdrama():
    n = 1
    for ax in _KDRAMA_ORDER:
        n *= max(1, len(AXIS_FRAGMENTS_KDRAMA.get(ax, {})))
    return int(n * 0.55)   # 7-axis prunes harder
...
def select_beatmap(topic, style, *, tenant_id=None, override=None, twist_override=None,
    ...
    """Extended selector.
      ...
      mode='compose' — free-compose from axis fragments (romance / coming_of_age / kdrama).
    ...
    if not family:
        return None
    bm = None
    _cstyle = (style or "").strip().lower()
    if mode == "compose" and _cstyle in _COMING_OF_AGE_STYLES:
        for _ in range(30):
            axes = {a: random.choice(list(AXIS_FRAGMENTS_COMING_OF_AGE[a].keys()))
                    for a in _COA_ORDER}
            bm = compose_beatmap_coming_of_age(axes)
            if bm:
                break
        if not bm:
            return None
    elif mode == "compose" and family == "romance":
        for _ in range(20):
            axes = {
        ...
        if not bm:
            return None
    elif mode == "compose" and family == "kdrama":
        for _ in range(40):
            axes = {a: random.choice(list(AXIS_FRAGMENTS_KDRAMA[a].keys()))
                    for a in _KDRAMA_ORDER}
            bm = compose_beatmap_kdrama(axes)
            if bm:
                break
        if not bm:
            return None
