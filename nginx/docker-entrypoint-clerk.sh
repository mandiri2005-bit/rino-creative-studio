...
for f in /usr/share/nginx/html/*.html /usr/share/nginx/html/app/*.html /usr/share/nginx/html/image/*.html /usr/share/nginx/html/video/*.html /usr/share/nginx/html/video-instant/*.html /usr/share/nginx/html/project/*.html /usr/share/nginx/html/storyboard/*.html /usr/share/nginx/html/voiceover/*.html /usr/share/nginx/html/music/*.html; do
